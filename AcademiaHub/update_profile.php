...
if(isset($_POST['submit'])){
   ...
   $parmament_address = $_POST['permament_address'];
        ...
        <!-- Name and Department-->
            ...
            <div id="container">
                ...
                <div id="pro_border" class="profile_sec_1">
                    ...
                    <label for="permament_address">Permament Address : <input class="profile_label" type="text" name="permament_address" value="<?php echo $_SESSION['student_log']['permanent_add'];?>"></label>
                    </div>
                </div>
            </div>
